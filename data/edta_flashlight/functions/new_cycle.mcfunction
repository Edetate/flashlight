execute as @e[type=area_effect_cloud,tag=edta_fl_marker] at @s run function edta_flashlight:restore
...
execute as @a[scores={edta_fl_light_on=1}] at @s anchored eyes positioned ^ ^ ^1 run function edta_flashlight:raycast
